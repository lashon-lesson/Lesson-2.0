const CACHE_NAME = 'lashon-v4';
const BASE = '/Lesson-2.0/';

// קבצים לשמירה במטמון לשימוש offline
// cache.addAll הוא אטומי — קובץ אחד חסר (404) מפיל את כל התקנת ה-Service Worker.
// לכן נשמרת מראש רק מעטפת האפליקציה. קובצי השיעורים נשמרים ממילא בזמן אמת
// דרך מנגנון ה-fetch שלמטה, בפעם הראשונה שתלמיד פותח אותם.
const PRECACHE = [
  BASE,
  BASE + 'index.html',
  BASE + 'manifest.json',
